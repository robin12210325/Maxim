...
public class MaximAdapter extends RecyclerView.Adapter<MaximAdapter.ViewHolder> {
    ...
    public MaximAdapter(Context context, List<MaximModel> dataList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_maxim, parent, false);
